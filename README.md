...
5. [Анализ ошибок SGD модели](#5-Анализ-ошибок-SGD-модели)
6. [Подбор гиперпараметров деревяных моделей](#6-Подбор-гиперпараметров-деревяных-моделей)
7. [Интерпретация: важность признаков](#7-интерпретация-важность-признаков)
9. [Выводы](#8-выводы)
10. [Воспроизведение](#9-воспроизведение)
...
| Модель | MAPE ↓ | R² ↑ |
|---|---|---|
| Линейная регрессия (Ridge/Lasso) | *0.18* | *0.83* |
| SGD (Huber) | *0.16* | *0.81* |
...
## 6. Подбор гиперпараметров деревяных моделей
