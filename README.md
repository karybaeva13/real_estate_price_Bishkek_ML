...
4. [Сравнение моделей](#4-сравнение_моделей)
5. [SGD. Анализ ошибок](#5-SGD._Анализ_ошибок)
6. [Деревяные модели. Подбор гиперпараметров](#6-Деревяные_модели._Подбор_гиперпараметров)
